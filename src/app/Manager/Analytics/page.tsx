      ...
      <main className="p-8 max-w-7xl mx-auto w-full flex-1 flex flex-col gap-6">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
          ...
          >
            ...
            <p className="text-xs text-gray-500 mb-8">Monthly attendance distribution</p>
            <div className="flex-1 flex items-center justify-center relative">
              ...
              ></div>
              <span className="absolute left-8 top-12 text-xs font-medium text-green-600">Present: 67%</span>
              <span className="absolute right-12 bottom-8 text-xs font-medium text-yellow-600">Late: 33%</span>
              <span className="absolute right-2 top-20 text-xs font-medium text-purple-400 opacity-50">Absent: 0%</span>
            </div>
          </div>
          ...
          <div className="space-y-3">
            {[
              ...
              <div key={i} className="bg-[#f9fafb] border border-gray-100 rounded-xl p-4 flex justify-between items-center">
                ...
                <span className="text-sm text-gray-500 font-medium">{emp.status}</span>
              </div>
            ))}
          </div>
        </div>
