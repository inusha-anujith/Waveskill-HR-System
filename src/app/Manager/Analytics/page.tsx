      ...
      <main className="p-8 max-w-7xl mx-auto w-full flex-1 flex flex-col gap-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
          ...
          <div className="bg-white rounded-2xl border border-gray-200 p-6 shadow-sm">
            ...
            <p className="text-xs text-gray-400">{checkedIn} checked in / {absent} absent today</p>
          </div>
          ...
          {/* OUT OF SCOPE: Active Projects (placeholder) */}
          <div className="bg-white rounded-2xl border border-gray-200 p-6 shadow-sm">
            <div className="flex justify-between items-start mb-2">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
          ...
          <div
            ...
            className="bg-white rounded-2xl border border-gray-200 p-6 shadow-sm flex flex-col cursor-pointer hover:shadow-md hover:border-gray-300 transition-all group"
          >
            <h3 className="text-sm font-semibold text-gray-900 group-hover:text-blue-600 transition-colors">Attendance Overview</h3>
            <p className="text-xs text-gray-500 mb-8">Today's attendance distribution</p>
            <div className="flex-1 flex items-center justify-center relative">
              ...
              ></div>
              <span className="absolute left-8 top-12 text-xs font-medium text-green-600">Present: {presentPct}%</span>
              <span className="absolute right-12 bottom-8 text-xs font-medium text-yellow-600">Late: {latePct}%</span>
              <span className="absolute right-2 top-20 text-xs font-medium text-purple-400 opacity-50">Absent: {absent}</span>
            </div>
          </div>
          ...
          >
            ...
            <p className="text-xs text-gray-500 mb-6">Status distribution</p>
            ...
            <div className="flex justify-around ml-6 mt-2 text-xs text-gray-500">
          ...
          >
            ...
            <p className="text-xs text-gray-500 mb-6">Employees by department</p>
            ...
            <div className="flex justify-around ml-4 mt-2 text-xs text-gray-500">
          ...
          >
            ...
            <p className="text-xs text-gray-500 mb-8">Project distribution by status</p>
            <div className="flex-1 flex items-center justify-center relative">
              ...
              <span className="absolute left-1/4 top-1/2 text-xs font-medium text-blue-500 -translate-y-1/2 bg-white px-1">Active: 2</span>
            </div>
          </div>
        </div>

        {/* IN SCOPE: Employee Availability */}
        <div className="bg-white rounded-2xl border border-gray-200 p-6 shadow-sm mt-2">
          <div className="mb-4">
            ...
            <p className="text-xs text-gray-500">Current status overview</p>
          </div>
