      ...
      <main className="p-8 max-w-7xl mx-auto w-full flex-1 flex flex-col gap-6">
        <div className="bg-white rounded-2xl border border-gray-200 p-8 flex-1">
          ...
          <div className="flex flex-col md:flex-row justify-between items-start md:items-center mb-8 gap-4">
            <div>
              <h2 className="text-xl font-semibold text-gray-900 mb-1">System Announcements</h2>
              <p className="text-sm text-gray-500">Create and manage company-wide system announcements</p>
            </div>
            <button
              onClick={openNew}
          ...
          {loading ? (
            ...
            <p className="text-sm text-gray-400 text-center py-8">No system announcements yet.</p>
          ) : (
          ...
          <div className="bg-white rounded-3xl w-full max-w-xl p-8 shadow-xl relative">
            <div className="flex justify-between items-center mb-6">
              <h2 className="text-xl font-bold text-gray-900">
                {editing ? 'Edit Announcement' : 'New System Announcement'}
              </h2>
